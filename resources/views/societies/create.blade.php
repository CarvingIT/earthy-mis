    ...
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-3xl font-extrabold leading-tight text-slate-900">Create Society</h2>
            </div>
            <p class="max-w-xl text-sm font-medium text-slate-500">Add a new society profile with location, onboarding, and primary contact information.</p>
        </div>
    </x-slot>
            ...
            <section class="form-panel reveal rounded-2xl p-5">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-slate-900">New society profile</h3>
                            <p class="text-sm font-medium text-slate-500">Capture only what is available now; optional details can be completed later.</p>
                        </div>
                    </div>
            ...
            <form method="POST" action="{{ route('societies.store') }}">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_20rem]">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div class="md:col-span-2">
                                        ...
                                        <x-text-input id="name" name="name" type="text" class="form-field mt-2 block w-full" :value="old('name')" required autofocus placeholder="Green Heights Society" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="city" name="city" type="text" class="form-field mt-2 block w-full" :value="old('city')" placeholder="Ahmedabad" />
                                        <x-input-error class="mt-2" :messages="$errors->get('city')" />
                                    </div>

                                    <div>
                                        <label for="joining_month" class="form-label">Joining month</label>
                                        <x-text-input id="joining_month" name="joining_month" type="text" class="form-field mt-2 block w-full" :value="old('joining_month')" placeholder="March" />
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <x-text-input id="chairman_name" name="chairman_name" type="text" class="form-field mt-2 block w-full" :value="old('chairman_name')" placeholder="Full name" />
                                        <x-input-error class="mt-2" :messages="$errors->get('chairman_name')" />
                                    </div>

                                    <div>
                                        <label for="secretary_name" class="form-label">Secretary name</label>
                                        <x-text-input id="secretary_name" name="secretary_name" type="text" class="form-field mt-2 block w-full" :value="old('secretary_name')" placeholder="Full name" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="contact_person_email" name="contact_person_email" type="email" class="form-field mt-2 block w-full" :value="old('contact_person_email')" placeholder="name@example.com" />
                    ...
                    <aside class="form-aside reveal h-fit rounded-2xl p-5" style="--reveal-delay: 160ms;">
                        ...
                        <p class="mt-2 text-sm font-medium leading-6 text-slate-500">The society name is required. All other fields are optional and can be updated whenever the profile is more complete.</p>

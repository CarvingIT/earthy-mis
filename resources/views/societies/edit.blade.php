                            ...
                            <div class="relative z-10">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="billing_amount" name="billing_amount" type="number" step="0.01" class="form-field mt-2 block w-full" :value="old('billing_amount', $society->billing_amount)" placeholder="10000.00" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="rate_per_flat" name="rate_per_flat" type="number" step="0.01" class="form-field mt-2 block w-full bg-slate-50" :value="old('rate_per_flat', $society->rate_per_flat)" placeholder="50.00" readonly />
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (flatsInput && billingInput && rateInput) {
                    ...
                    // Do not overwrite existing value immediately if loaded, but bind calculation
                    flatsInput.addEventListener('input', calculateRate);
                    billingInput.addEventListener('input', calculateRate);
                }
            });

    ...
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-3xl font-extrabold leading-tight text-slate-900">Create Sale</h2>
            </div>
            <p class="max-w-xl text-sm font-medium text-slate-500">Record a new customer sale with product details, pricing, and payment information.</p>
        </div>
    </x-slot>
            ...
            <section class="form-panel reveal rounded-2xl p-5">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-slate-900">New sales transaction</h3>
                            <p class="text-sm font-medium text-slate-500">Record a new customer sale with product details and pricing.</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_20rem]">
                    <div class="space-y-6">
                        ...
                        <section class="form-panel reveal rounded-2xl p-6 sm:p-8" style="--reveal-delay: 70ms;">
                            <div class="mb-6">
                                <h3 class="text-xl font-extrabold text-slate-900">Sale Entry Details</h3>
                                <p class="mt-1 text-sm font-medium text-slate-500">Fill in the details below to record a new customer sale.</p>
                            </div>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs font-medium text-slate-500">When did this sale happen?</p>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs font-medium text-slate-500">Who is purchasing this product?</p>
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs font-medium text-slate-500">Which product is being sold?</p>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="quantity" name="quantity" type="number" step="0.01" min="0.01" class="form-field mt-2 block w-full" :value="old('quantity')" placeholder="e.g., 50" onchange="calculateAmount();" oninput="calculateAmount();" required />
                                        <p class="mt-1 text-xs font-medium text-slate-500">How many units are being sold?</p>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <x-text-input id="rate" name="rate" type="number" step="0.01" min="0" class="form-field mt-2 block w-full" :value="old('rate')" oninput="calculateAmount();" placeholder="Auto-calculated" required />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="amount" name="amount" type="number" step="0.01" min="0" class="form-field mt-2 block w-full" :value="old('amount')" placeholder="Auto-calculated" required />
                    ...
                    <aside class="form-aside reveal h-fit rounded-2xl p-5" style="--reveal-delay: 170ms;">
                        ...
                        <div class="mt-6 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                            ...
                            <ul class="mt-2 space-y-1 text-xs font-medium text-slate-600">
                                ...
                                <li>• Stock automatically reduces on save</li>
                            </ul>
                        </div>
                    </aside>
                </div>

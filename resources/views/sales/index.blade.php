    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 flex justify-end">
                <a href="{{ route('sale.create') }}" class="px-4 py-2 text-white rounded-md" style="background-color:#16a34a;border:1px solid #16a34a;" onmouseover="this.style.backgroundColor='#15803d';this.style.borderColor='#15803d'" onmouseout="this.style.backgroundColor='#16a34a';this.style.borderColor='#16a34a'">Add Sale</a>
            </div>
                        ...
                        @forelse ($sales as $sale)
                            <tr>
                                ...
                                <td class="px-4 py-2 text-right space-x-3">
                                    ...
                                    <form class="inline" method="POST" action="{{ route('sale.destroy', $sale) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-red-600" onclick="return confirm('Delete this Sale?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @empty

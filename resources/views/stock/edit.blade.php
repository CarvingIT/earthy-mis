            ...
            <section class="form-panel reveal rounded-2xl p-5">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-slate-900">Edit stock transaction</h3>
                            <p class="text-sm font-medium text-slate-500">Update stock transaction details and correct any information.</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_20rem]">
                    <div class="space-y-6">
                        ...
                        <section class="form-panel reveal rounded-2xl p-6 sm:p-8" style="--reveal-delay: 70ms;">
                            <div class="mb-6">
                                <h3 class="text-xl font-extrabold text-slate-900">Transaction Details</h3>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <x-text-input id="Date" name="Date" type="date" class="form-field mt-2 block w-full" :value="old('Date', $stock->Date)" required />
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div>
                                        ...
                                        <x-text-input id="quantity" name="quantity" type="number" min="0.01" step="0.01" class="form-field mt-2 block w-full" :value="old('quantity', $stock->quantity)" placeholder="e.g., 100" required />
                                        <p class="mt-1 text-xs font-medium text-slate-500" id="quantity-help">How much are you updating?</p>
                            ...
                            <div class="space-y-5">
                                <div>
                                    <label for="transaction_type" class="form-label">Why are you updating stock? <span class="text-rose-500">*</span></label>
                                    <select name="transaction_type" id="transaction_type" class="form-field mt-2 block w-full px-4 py-2.5 shadow-sm" required>
                                        ...
                                        <option value="purchase" {{ old('transaction_type', $stock->transaction_type) == 'purchase' ? 'selected' : '' }}>🛒 Purchase (bought new stock from supplier)</option>
                                        <option value="opening_stock" {{ old('transaction_type', $stock->transaction_type) == 'opening_stock' ? 'selected' : '' }}>📋 Opening Stock (initial inventory setup)</option>
                                        <option value="return" {{ old('transaction_type', $stock->transaction_type) == 'return' ? 'selected' : '' }}>↩️ Return (customer returned products)</option>
                                        <option value="adjustment" {{ old('transaction_type', $stock->transaction_type) == 'adjustment' ? 'selected' : '' }}>🔧 Adjustment (correcting inventory count)</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <textarea id="notes" name="notes" rows="3" class="form-field mt-2 block w-full px-4 py-3 shadow-sm" placeholder="Examples: Supplier name, PO number, batch details...">{{ old('notes', $stock->notes) }}</textarea>

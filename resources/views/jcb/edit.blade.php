<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-3xl font-extrabold leading-tight text-slate-900">Edit JCB Entry</h2>
            </div>
            <p class="max-w-xl text-sm font-medium text-slate-500">Update JCB operation details and correct any information.</p>
        </div>
    </x-slot>
    ...
    <div class="py-8 jcb-form-shell">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('jcb.update', $jcb) }}" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                @csrf
                @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="form-panel form-section reveal-up" style="animation-delay: 0.05s">
                        ...
                        <div class="form-field">
                            ...
                            <input id="Date" name="Date" type="date" class="form-input" value="{{ old('Date', $jcb->Date) }}" required />
                            @error('Date')
                        ...
                        <div class="form-field">
                            ...
                            <input id="duration" name="duration" type="text" class="form-input" value="{{ old('duration', $jcb->duration) }}" placeholder="e.g., 2 hours, 45 minutes" required />
                            @error('duration')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="form-panel form-section reveal-up" style="animation-delay: 0.1s">
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="description" name="description" class="form-textarea" placeholder="Describe the JCB operation...">{{ old('description', $jcb->description) }}</textarea>
                            @error('description')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                ...
                <div class="space-y-6">
                    ...
                    <div class="form-aside form-section reveal-up" style="animation-delay: 0.2s">
                        <div class="tip-box">
                            ...
                            <p>Keep JCB operation records accurate for better equipment management and maintenance planning.</p>
                        </div>
                    </div>

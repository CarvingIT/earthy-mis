<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-3xl font-extrabold leading-tight text-slate-900">Edit Windrow</h2>
            </div>
            <p class="max-w-xl text-sm font-medium text-slate-500">Update windrow details and correct any information.</p>
        </div>
    </x-slot>
    ...
    <div class="py-8 windrow-form-shell">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('windrow.update', $windrow) }}" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                @csrf
                @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="form-panel form-section reveal-up" style="animation-delay: 0.05s">
                        ...
                        <div class="form-field">
                            ...
                            <input id="windrow_number" name="windrow_number" type="text" class="form-input" value="{{ old('windrow_number', $windrow->windrow_number) }}" placeholder="e.g., WR-001" required />
                    ...
                    <div class="form-panel form-section reveal-up" style="animation-delay: 0.1s">
                        ...
                        <div class="form-field">
                            ...
                            <input id="start_date" name="start_date" type="date" class="form-input" value="{{ old('start_date', $windrow->start_date) }}" required />
                            @error('start_date')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-field">
                            ...
                            <input id="end_date" name="end_date" type="date" class="form-input" value="{{ old('end_date', $windrow->end_date) }}" />
                            @error('end_date')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-field">
                            ...
                            <input id="out_date" name="out_date" type="date" class="form-input" value="{{ old('out_date', $windrow->out_date) }}" />
                            @error('out_date')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-field">
                            ...
                            <input id="screening_date" name="screening_date" type="date" class="form-input" value="{{ old('screening_date', $windrow->screening_date) }}" />
                ...
                <div class="space-y-6">
                    ...
                    <div class="form-aside form-section reveal-up" style="animation-delay: 0.2s">
                        <div class="tip-box">
                            ...
                            <p>Review the windrow details carefully before updating. Changes will be reflected immediately in your composting management records.</p>
                        </div>
                    </div>
